...
export default function SignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true)
    try {
      await authApi.register(Number(fid))
      const loginData = await authApi.login(Number(fid), password)
  ...
  return (
    <AuthCard>
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div>
          <label style={{ ...labelStyle, textAlign: "left" }}>Confirm Password</label>
          <input
      ...
      <p style={{
        ...
        <Link href="/login" style={{ color: C.gold, textDecoration: "none", fontWeight: 600 }}>
          Sign in
        </Link>
      </p>
    </AuthCard>
